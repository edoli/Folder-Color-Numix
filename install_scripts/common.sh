...
sed -i 's/python-nautilus, nautilus, /gvfs-bin, /' ../debian/control
sed -i 's/Breaks: .*/Breaks: folder-color (<< 0.0.37), folder-color-nemo (<< 0.0.37), folder-color-caja (<< 0.0.37)/' ../debian/control
sed -i 's/Replaces: .*/Replaces: folder-color (<< 0.0.37), folder-color-nemo (<< 0.0.37), folder-color-caja (<< 0.0.37)/' ../debian/control
